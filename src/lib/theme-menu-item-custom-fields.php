...
class AltMenuItemCustomFields {
	...
	public static function init() {
		...
		self::$fields = array(
			'columns' => __( 'Grid Columns', 'AltMenuItemCustomFields' ),
			'image' => __( 'Background Image URL', 'AltMenuItemCustomFields' ),
		);
	}
